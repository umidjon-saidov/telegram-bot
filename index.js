...
//     if (text === "/start") {
//       videoMode = false;  // Boshqa komandalarda holatni o'chirib qo'yish
//       return bot.sendMessage(
//         chatId,
//         `Assalomu aleykum hurmatli ${msg.from.first_name}! Video yasovchi botga xush kelibsiz. ismga va harfga video yasatmoqchi bo'lsangiz /video ni bosing.`
//       );
...
//       );
//     } else if (text === "/video") {
//       videoMode = true;  // Foydalanuvchi video rejimiga kiradi
//       bot.sendMessage(chatId, `Video uchun ism yoki harf yuboring!`);
//     } else if (videoMode) { // Faqat videoMode true bo'lganda matnlarni qabul qiladi
//       const videoMapping = {
//         avazbek: "video/174C29D83E1FB88533718A4754D145A5_video_dashinit.mp4",
//         shahlo: "video/video_2024-08-16_14-07-25.mp4",
//         sevinch: "video/video_2024-08-19_13-07-22.mp4",
...
//       const videoPath = videoMapping[text.toLowerCase()];
//       if (videoPath) {
//         try {
//           await bot.sendVideo(chatId, videoPath, {
//             caption: `${msg.text} ismi uchun video`,
...
//       }
//     } else {
//       bot.sendMessage(chatId, "Iltimos, avval /video komandasini bosing.");
//     }
//   });
// };
...
const bootstrap = () => {
  ...
  bot.on("message", async (msg) => {
    ...
    if (text === "/start") {
      ...
      // Faqat videoMode true bo'lganda matnlarni qabul qiladi
      const videoMapping = {
        avazbek: "video/174C29D83E1FB88533718A4754D145A5_video_dashinit.mp4",
        shahlo: "video/video_2024-08-16_14-07-25.mp4",
        sevinch: "video/video_2024-08-19_13-07-22.mp4",
